...
$.ajax({
  ...
  data: {
    key: 'I3EBZ-WMBEM-XTD63-6XE2G-I2H3J-AJFQT',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function createtime1() {
  var grt = new Date("10/25/2023 00:00:00"); //此处修改你的建站时间或者网站上线时间
  ...
  var ascll = [
    ...
    \_   _____/  _  \__    ___/\__    ___/|   |/  _____/\_   _____/\______   \
     |    __)/  /_\  \|    |     |    |   |   /   \  ___ |    __)_  |       _/
     |     \/    |    \    |     |    |   |   \    \_\  \|        \ |    |   \
     \___  /\____|__  /____|     |____|   |___|\______  /_______  / |____|_  /
         \/         \/                                \/        \/         \/ 
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("10/25/2023 00:00:00");
